...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "organization_admin": {"org.*", "workspace.*", "project.*", "entities.*",
                           "sources.manage", "alerts.manage", "reports.*", "survey.*", "view"},
    "executive":     {"view", "reports.view", "reports.export",
                      "survey.view_analytics", "survey.generate_report"},
    "analyst":       {"view", "workspace.view", "project.create", "project.edit",
                      "entities.manage", "reports.view", "reports.export",
                      "survey.view_responses", "survey.view_analytics",
                      "survey.export_responses", "survey.review_quality"},
    "researcher":    {"view", "workspace.view", "entities.manage",
                      "reports.view", "reports.export",
                      "survey.create", "survey.edit", "survey.publish", "survey.pause",
                      "survey.close", "survey.view_responses", "survey.view_analytics",
                      "survey.export_responses", "survey.generate_report",
                      "survey.manage_distribution", "survey.review_quality"},
