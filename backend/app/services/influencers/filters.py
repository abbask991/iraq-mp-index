...
_CHANNEL = [_norm(w) for w in [
    ...
    "reuters", "رويترز", "afp", "ا ف ب", "bbc", "بي بي سي", "rt ", "روسيا اليوم",
    "sky", "سكاي", "france24", "فرانس", "cnn", "dw", "الحرة", "العربي الجديد",
    "associated press", "اسوشيتد", "anadolu", "الاناضول", "sputnik", "سبوتنيك",
    # sports / football
    "football", "كرة", "كورة", "الرياضي", "fc ", "نادي", "كأس", "دوري", "هدف",
]]
