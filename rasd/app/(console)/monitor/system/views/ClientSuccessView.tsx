  ...
  return (
    <div>
      ...
      <div className="cbox" style={{ marginTop: 14, borderInlineStart: "4px solid #f59e0b" }}>
        <b>مقاييس التفاعل — قيد التتبّع</b>
        <p className="muted" style={{ fontSize: 12.5, margin: "6px 0 0" }}>
          تسجيلات الدخول، التقارير المولّدة، الأدلّة المفتوحة، أسئلة المحلّل، والوحدات الأكثر استخداماً تتطلّب سجلّ أحداث استخدام لكل عميل — غير مُحتسبة بعد بدل عرض أرقام غير حقيقية. صحة العميل أعلاه مبنية على الباقة والحالة الفعليتين.
        </p>
      </div>
    </div>
  );
