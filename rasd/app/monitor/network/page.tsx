...
export default function Network() {
 ...
 <span className="muted" style={{ fontSize: 11, marginInlineStart: 8 }}> X يحلّل آخر ٧ أيام فقط</span>
          )}
 </div>
        {monitors.length > 0 && (
 ...
 <div style={{ fontSize: 30 }}>{res.organized ? "" : res.pct_suspicious >= 20 ? "" : ""}</div>
 ...
 <b> نسخ-لصق منظّم ({res.duplicate_clusters.length})</b>
